...
import fr.exratio.devkit.core.json.ColorRGBASerializer;
import fr.exratio.devkit.core.json.QuaternionSerializer;
import fr.exratio.devkit.core.json.Vector3fSerializer;
import java.io.File;
...
public class DevKitConfig {
  ...
  protected void setSdkConfig(SdkConfig sdkConfig) {
  ...
  protected void setProjectConfig(ProjectConfig projectConfig) {
  ...
  protected void setSceneConfig(SceneConfig sceneConfig) {
