...
import fr.exratio.devkit.properties.builder.GeometryPropertySectionBuilder;
import fr.exratio.devkit.properties.builder.MaterialPropertySectionBuilder;
import fr.exratio.devkit.properties.builder.SpatialPropertySectionBuilder;
import fr.exratio.devkit.properties.component.bool.BooleanEditor;
import fr.exratio.devkit.properties.component.colorgba.ColorRGBAEditor;
import fr.exratio.devkit.properties.component.control.AnimComposerEditor;
import fr.exratio.devkit.properties.component.control.AnimControlEditor;
import fr.exratio.devkit.properties.component.enumeration.EnumEditor;
import fr.exratio.devkit.properties.component.floatc.FloatEditor;
import fr.exratio.devkit.properties.component.integer.IntegerEditor;
import fr.exratio.devkit.properties.component.material.MaterialChooserEditor;
import fr.exratio.devkit.properties.component.quaternion.QuaternionEditor;
import fr.exratio.devkit.properties.component.string.StringEditor;
import fr.exratio.devkit.properties.component.texture2d.Texture2DEditor;
import fr.exratio.devkit.properties.component.vector2f.Vector2fEditor;
import fr.exratio.devkit.properties.component.vector3f.Vector3fEditor;
import fr.exratio.devkit.properties.component.vector4f.Vector4fEditor;
import fr.exratio.devkit.registration.Registrar;
import fr.exratio.devkit.registration.control.ControlRegistrar;
import fr.exratio.devkit.registration.control.NoArgsControlRegistrar;
import fr.exratio.devkit.registration.spatial.AssetLinkNodeRegistrar;
import fr.exratio.devkit.registration.spatial.BatchNodeRegistrar;
import fr.exratio.devkit.registration.spatial.GeometryRegistrar;
import fr.exratio.devkit.registration.spatial.InstancedNodeSpatialRegistrar;
import fr.exratio.devkit.registration.spatial.NoArgsSpatialRegistrar;
import fr.exratio.devkit.registration.spatial.NodeRegistrar;
