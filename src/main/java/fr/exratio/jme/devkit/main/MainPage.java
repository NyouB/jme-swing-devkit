...
import fr.exratio.jme.devkit.main.ZonedToolBar.ToolBarZone;
...
public class MainPage extends JPanel {
  ...
  public MainPage() {
    ...
    Zone.RIGHT_BOTTOM.setConcreteZone(
        new ConcreteZone(Zone.RIGHT_BOTTOM, rightToolBar.getFirstZone(),
  ...
  private void initComponents() {
    ...
    setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.TitledBorder(new
        javax.swing.border.EmptyBorder(0, 0, 0, 0), "JFor\u006dDesi\u0067ner \u0045valu\u0061tion",
        javax
