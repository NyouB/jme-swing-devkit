...
public interface ClassRegistrar<T> {
    ...
    /**
     * Creates a TreeNode for the SceneTree whenever the registered class is added to the scene.
     * Also allows you to create a context menu to create additional actions for the registered item.
     * For example a BatchNode has a "batch" menu item in its context menu.
     *
     * If this method returns null the default TreeNode will be used instead.
     * For example if the registered item is a Geometry, a GeometryTreeNode will be created.
     *
