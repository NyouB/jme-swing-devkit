package com.jayfella.importer.plugin.exception;
...
public class InvalidPluginConfigurationException extends Exception {
    ...
    public InvalidPluginConfigurationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
